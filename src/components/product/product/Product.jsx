    ...
    return <>
        ...
        <div className="row mt-2" style={{ border: "1px solid #f3f2f2", padding: "5%" }}>
            ...
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12  mt-2">
                <span className="card-subtitle" style={{ fontSize: "0.9rem", color: "$888891", opacity: "0.75", fontWeight: "600", }}>
                    {props.product.title}
                </span> <br />
            ...
            <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12  mt-3 mb-3 " style={{ padding: "1px " }}>
                <button type="button" class="btn btn-secondary" style={props.serial == 0 ? { paddingTop: "10px", paddingBottom: "10px", fontSize: "0.78rem", background: "#FEDD21", border: "none", color: "white", fontWeight: "600" } : { paddingTop: "10px", paddingBottom: "10px", fontSize: "0.78rem", background: "#F4F4F4", border: "none", color: "#606164", fontWeight: "600" }}>ADD TO CART</button>
            </div>
